...
import com.ramybaheeg.yetanotherwidget.databinding.LeftAlignedWidgetBinding
...
import com.ramybaheeg.yetanotherwidget.helpers.ImageHelper.applyShadow
import com.ramybaheeg.yetanotherwidget.helpers.RuntimeLog
import com.ramybaheeg.yetanotherwidget.receivers.NewCalendarEventReceiver
import com.ramybaheeg.yetanotherwidget.receivers.WidgetClickListenerReceiver
    ...
    private fun updateGridView(bindingView: LeftAlignedWidgetBinding, views: RemoteViews, widgetID: Int): RemoteViews {
        try {
            ...
            if (WeatherHelper.hasDisplayableWeather()) {
                ...
                val weatherPIntent = PendingIntent.getBroadcast(context, widgetID, i, PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE)
