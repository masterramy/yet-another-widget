    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        adapter.register<GlanceProvider>(R.layout.glance_provider_item) { item, injector ->
            ...
            when (provider) {
                ...
                Constants.GlanceProviderId.GOOGLE_FIT_STEPS -> { injector.text(R.id.label, getString(R.string.settings_not_visible)); injector.visibility(R.id.error_icon, View.GONE); injector.visibility(R.id.info_icon, View.VISIBLE); isVisible = false }
